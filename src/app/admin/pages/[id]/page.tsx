      ...
      <header className="flex flex-col gap-5 sm:gap-8 border-b border-zinc-100 pb-6 sm:pb-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 sm:gap-8">
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-zinc-500 text-sm max-w-md hidden sm:block">Controle de páginas estáticas e conteúdo modular (PRD Seção 8).</p>
          </div>

          <div className="flex items-center gap-3">
            <Button variant="ghost" onClick={() => router.push("/admin/pages")} className="h-10 sm:h-14 px-4 sm:px-8 rounded-lg text-[10px] font-medium uppercase tracking-widest text-zinc-400 font-ui hidden sm:flex">Cancelar</Button>
          </div>
        </div>
      </header>
        ...
        <Tabs defaultValue="base" className="w-full">
          <div className="overflow-x-auto no-scrollbar mb-8 sm:mb-16">
            <TabsList className="w-max">
              ...
              <TabsTrigger value="content" className="text-xs sm:text-sm">Editor Modular</TabsTrigger>
          ...
          <div className="bg-white/90 backdrop-blur-3xl border border-zinc-100 p-4 sm:p-8 rounded-2xl shadow-2xl flex items-center justify-between gap-3 animate-in slide-in-from-bottom-8 duration-700">
            <div className="flex items-center gap-3 sm:gap-6 sm:pl-4 font-ui">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[9px] text-zinc-400 uppercase tracking-widest text-left font-ui">{formData.status === 'published' ? 'Ao vivo' : 'Rascunho'}</span>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-4">
              <Button variant="ghost" onClick={() => router.push("/admin/pages")} className="h-10 sm:h-14 px-4 sm:px-8 rounded-lg text-[10px] font-medium uppercase tracking-widest text-zinc-400 hover:text-zinc-900 font-ui hidden sm:flex">Descartar</Button>
              <Button variant="premium" onClick={handleSave} className="px-6 sm:px-12 h-11 sm:h-16 rounded-xl gap-2 sm:gap-4 font-ui text-[11px] uppercase tracking-widest font-medium">
                ...
                <span className="hidden sm:inline">Confirmar &amp; Salvar</span>
