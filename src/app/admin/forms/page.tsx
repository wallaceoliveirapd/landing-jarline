    ...
    <div className="max-w-[1200px] mx-auto space-y-12 py-8 pb-32">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8 border-b border-zinc-100 pb-12">
        <div className="space-y-4">
          ...
          <h2 className="text-4xl font-medium tracking-tight text-zinc-900 font-ui  ">Formulários de Captura</h2>
          <p className="text-zinc-500 text-sm max-w-md  ">Configure os pontos de entrada de novos clientes e orçamentos (PRD Seção 9).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-12 rounded-2xl bg-primary text-white space-y-8 flex flex-col justify-between relative overflow-hidden group">
          <div className="space-y-6 relative z-10">
            <div className="size-14 rounded-2xl bg-white/10 flex items-center justify-center backdrop-blur-xl group-hover:bg-white group-hover:text-primary transition-all duration-700">
              <Sparkles className="size-6 shadow-sm" />
            </div>
            <div className="space-y-2">
              <h3 className="text-3xl font-medium font-ui leading-tight">Análise Preditiva (Jal)</h3>
        ...
        <div className="p-12 rounded-2xl border border-zinc-100 bg-white space-y-8 flex flex-col">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="h-px w-6 bg-primary" />
              <h4 className="font-ui font-medium text-zinc-900 text-3xl">Pronto para Ecossistemas</h4>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {['WhatsApp', 'E-mail SMTP', 'RD Station', 'Google Sheets'].map((int) => (
                <div key={int} className="px-6 py-5 rounded-2xl bg-zinc-50 flex items-center justify-center border border-zinc-100 hover:bg-primary hover:text-white hover:border-primary transition-all duration-500 cursor-pointer group/int">
