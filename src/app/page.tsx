...
export default function Page() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (aiSendBtn && aiMessage) {
        aiSendBtn.addEventListener('click', () => {
          const msg = aiMessage.value.trim();
          const text = msg
            ? `Olá! Vim pelo site e gostaria de compartilhar meu projeto:\n\n${msg}`
      ...
      <div className="hero-inner">
        ...
        <div className="hero-card parallax-layer reveal" data-parallax="4">
          <div className="hero-text">
            <p className="hero-eyebrow reveal d1">Soluções em arquitetura e interiores</p>
            <h1 className="hero-headline reveal d2">Arquitetura<br />com alma<br />e função</h1>
            <p className="hero-body reveal d3">Projetos que unem funcionalidade, estética e sensibilidade para criar
              ambientes que fazem sentido para a sua rotina, para o seu estilo e para o que você deseja viver.</p>
          </div>
          <div className="hero-actions reveal d4">
            <a href="#projetos" className="btn btn-cream">Ver projetos</a>
            <a href="#sobre" className="btn btn-ghost-light">Saber mais</a>
          </div>
        </div>
    ...
    <div className="container">
      <div className="stats-grid">
        <div className="stat-card reveal d1">
          <div className="stat-value" data-count="56" data-prefix="+">0</div>
          <div className="stat-label">Projetos entregues e executados</div>
        </div>
        <div className="stat-card reveal d2">
          <div className="stat-value" data-count="30" data-prefix="+">0</div>
          <div className="stat-label">Clientes satisfeitos</div>
        </div>
        <div className="stat-card reveal d3">
          <div className="stat-value" data-count="20" data-prefix="+">0</div>
          <div className="stat-label">Ambientes transformados</div>
        </div>
        <div className="stat-card reveal d4">
          <div className="stat-value" data-count="100" data-suffix="%">0</div>
          <div className="stat-label">Projetos pensados de forma personalizada</div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container">
      <div className="about-inner">
        <div className="about-text">
          <p className="about-intro reveal-l">Prazer, sou</p>
          <h2 className="about-name reveal-l d1">Jarline Vieira</h2>
          <div className="about-bio reveal d2">
            <p>Sou arquiteta e acredito que a arquitetura vai muito além de desenhar ambientes bonitos. Um espaço bem
              pensado pode melhorar a rotina, despertar sensações, valorizar histórias e transformar a forma como as
              pessoas vivem, trabalham e se conectam com o lugar onde estão.</p>
            <p>Meu trabalho é guiado pela escuta, pelo cuidado e pela busca de soluções que unam estética,
              funcionalidade e identidade. Cada projeto é desenvolvido de forma personalizada, respeitando o estilo de
              vida, as necessidades e os objetivos de cada cliente.</p>
            <p>Mais do que entregar um projeto, meu compromisso é proporcionar uma experiência leve, organizada e
              acolhedora em cada etapa do processo.</p>
          </div>
        </div>
  ...
  <section className="projects" id="projetos">
    <div className="container">
      <h2 className="section-heading white reveal">Meus projetos</h2>
      <div className="carousel-wrap">
        <div className="carousel" id="carousel">
          <div className="project-card">
            <div className="project-card-bg" style={{"backgroundImage":"url('assets/images/project-1.png')"}}></div>
            <div className="project-overlay"></div>
            <div className="project-info">
              <p className="project-title">Residência Contemporânea</p>
              <p className="project-desc">Interiores · João Pessoa</p>
            </div>
          </div>
          <div className="project-card">
            <div className="project-card-bg" style={{"backgroundImage":"url('assets/images/hero-bg.png')"}}></div>
            <div className="project-overlay"></div>
            <div className="project-info">
              <p className="project-title">Espaço Gourmet</p>
              <p className="project-desc">Arquitetônico · Recife</p>
            </div>
          </div>
          <div className="project-card">
            <div className="project-card-bg" style={{"backgroundImage":"url('assets/images/project-2.png')"}}></div>
            <div className="project-overlay"></div>
            <div className="project-info">
              <p className="project-title">Apartamento Manaíra</p>
              <p className="project-desc">Interiores · João Pessoa</p>
            </div>
          </div>
          <div className="project-card">
            <div className="project-card-bg" style={{"backgroundImage":"url('assets/images/project-3.png')"}}></div>
            <div className="project-overlay"></div>
            <div className="project-info">
              <p className="project-title">Casa de Campo</p>
              <p className="project-desc">Arquitetônico · Cabedelo</p>
            </div>
          </div>
          <div className="project-card">
            <div className="project-card-bg" style={{"backgroundImage":"url('assets/images/project-4.png')"}}></div>
            <div className="project-overlay"></div>
            <div className="project-info">
              <p className="project-title">Studio Corporativo</p>
              <p className="project-desc">Comercial · João Pessoa</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="container" style={{"position":"relative","zIndex":"1"}}>
      ...
      <div className="services-grid">
        <div className="service-card reveal d1">
          ...
          <p className="service-desc">Para quem precisa de direcionamento profissional, ideias mais claras e soluções
            práticas para o espaço, sem necessariamente contratar um projeto completo. Ideal para dúvidas pontuais,
            organização de ambientes, decoração, layout, escolhas de materiais e decisões específicas.</p>
        </div>
        <div className="service-card reveal d2">
          <p className="service-num">02</p>
          <h3 className="service-title">Projeto de Interiores</h3>
          <p className="service-desc">Desenvolvimento de ambientes internos com foco em conforto, funcionalidade, estética e
            identidade. Indicado para quem deseja transformar espaços residenciais ou comerciais de forma estratégica,
            harmoniosa e personalizada.</p>
        </div>
        <div className="service-card reveal d3">
          <p className="service-num">03</p>
          <h3 className="service-title">Projeto Arquitetônico</h3>
          <p className="service-desc">Planejamento completo do espaço, considerando distribuição, aproveitamento,
            funcionalidade e intenção estética. Ideal para construções, ampliações e projetos que exigem uma visão mais
            ampla, técnica e bem estruturada.</p>
        </div>
        <div className="service-card reveal d1">
          <p className="service-num">04</p>
          <h3 className="service-title">Reforma e Readequação de Ambientes</h3>
          <p className="service-desc">Para quem deseja renovar um ambiente existente, melhorar sua funcionalidade, atualizar
            a estética ou adaptar o espaço para uma nova fase, sempre buscando equilíbrio entre praticidade e resultado.
          </p>
        </div>
        <div className="service-card reveal d2">
          <p className="service-num">05</p>
          <h3 className="service-title">Acompanhamento e Orientação de Projeto</h3>
          <p className="service-desc">Suporte para auxiliar nas decisões ao longo do processo, trazendo mais segurança,
            clareza e alinhamento entre o planejado e o resultado desejado.</p>
        </div>
      </div>
  ...
  <section className="ai-section" id="orcamento">
    <div className="container">
      <div className="ai-header">
        <h2 className="ai-title reveal">Descubra por onde começar</h2>
        <p className="ai-subtitle reveal d1">Nem sempre é fácil saber qual serviço escolher ou como explicar tudo o que você
          precisa logo no primeiro contato. Pensando nisso, foi criado um chat com IA para te ajudar a organizar suas
          ideias de forma simples e natural.</p>
      </div>
      <div className="ai-card reveal d2">
        <div className="ai-agent-row">
          ...
          <div className="ai-agent-body">
            ...
            <p className="ai-agent-sub">Sou sua agente de IA, vou te ajudar a entender o que você precisa e te direcionar da
              melhor forma.</p>
            <ul className="ai-features">
              <li className="ai-feature">
                ...
                <span className="ai-feature-text">Você explica o que precisa do seu jeito</span>
              </li>
              <li className="ai-feature">
                <span className="ai-check"><svg viewBox="0 0 12 12">
                    <polyline points="2 6 5 9 10 3" />
                  </svg></span>
                <span className="ai-feature-text">A IA faz apenas perguntas essenciais</span>
              </li>
              <li className="ai-feature">
                <span className="ai-check"><svg viewBox="0 0 12 12">
                    <polyline points="2 6 5 9 10 3" />
                  </svg></span>
                <span className="ai-feature-text">Recebe uma orientação inicial mais clara</span>
              </li>
              <li className="ai-feature">
                <span className="ai-check"><svg viewBox="0 0 12 12">
                    <polyline points="2 6 5 9 10 3" />
                  </svg></span>
                <span className="ai-feature-text">Sua mensagem vai organizada direto para o WhatsApp</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="ai-input-box">
          <textarea id="ai-message" className="ai-textarea"
            placeholder="Você pode escrever, com suas próprias palavras, o que deseja para o seu espaço."
            rows="5" />
          <div className="ai-input-actions">
            <button className="btn btn-primary" id="ai-send-btn" type="button">Enviar mensagem</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="container">
      <div className="footer-grid">
        ...
        <div className="footer-brand reveal">
          ...
          <p className="footer-copyright">Todos os direitos reservados © 2026</p>
        </div>
        ...
        <div className="reveal d1">
          ...
          <div className="footer-contacts">
            <a href="https://wa.me/5581999999999" className="footer-contact-item">
            ...
            <a href="mailto:email@email.com" className="footer-contact-item">
        ...
        <div className="reveal d2">
          ...
          <div className="footer-contacts">
            <a href="#" className="footer-contact-item" style={{"alignItems":"flex-start"}}>
              ...
              Av. Monteiro da Franca, 815 — Manaíra, João Pessoa - PB
            </a>
          </div>
        </div>
  ...
  <div className="footer-map">
    <iframe
      ...
      title="Localização — Timbaúba, PE" loading="lazy" allowfullscreen>
    </iframe>
  </div>
